...
# Display the map HTML file in the big box frame using HtmlFrame
...
map_frame = HtmlFrame(app)
map_frame.load_file("/Users/ankur/Desktop/untitled folder/map.html")
map_frame.grid(row=1, column=4, rowspan=14, sticky="nsew", padx=(10, 20), pady=20)
