...
class FifthInterface(customtkinter.CTkFrame):
    def __init__(self, parent):
        ...
        radio_button_1 = customtkinter.CTkRadioButton(self, text="UK gallons (gal)", value=0)
        radio_button_1.grid(row=2, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Us gallon (gal)", value=0)
        radio_button_1.grid(row=3, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Litres (ml)", value=0)
        radio_button_1.grid(row=4, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Cubic centimetres (cc)(cm3)", value=0)
        radio_button_1.grid(row=5, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Cubic meters (m3)", value=0)
        radio_button_1.grid(row=6, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Cubic inches (in3)", value=0)
        radio_button_1.grid(row=7, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Cubic feet (ft3)", value=0)
        ...
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Cubic centimetres (cc)", value=0)
