...
class SeventeenInterface(customtkinter.CTkFrame):
    def __init__(self, parent):
        ...
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Binary", value=0)
        radio_button_1.grid(row=2, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Hexadecimal", value=0)
        radio_button_1.grid(row=3, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Octal", value=0)
        radio_button_1.grid(row=4, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Decimal", value=0)
        radio_button_1.grid(row=5, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Base 32", value=0)
        radio_button_1.grid(row=6, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Base 64", value=0)
