...
class ThirdInterface(customtkinter.CTkFrame):
    def __init__(self, parent):
        ...
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Millimeters (m)", value=0)
        radio_button_1.grid(row=2, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Centimeters (cm)", value=0)
        radio_button_1.grid(row=3, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Meter (m)", value=0)
        radio_button_1.grid(row=4, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Kilometers (km)", value=0)
        radio_button_1.grid(row=5, column=0, pady=10, padx=(20,10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Inches (in)", value=0)
        radio_button_1.grid(row=6, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Feet (ft)", value=0)
        radio_button_1.grid(row=7, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Yards (yd)", value=0)
        radio_button_1.grid(row=8, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Miles (mi)", value=0)
        radio_button_1.grid(row=9, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Nautical miles (NM)", value=0)
        radio_button_1.grid(row=10, column=0, pady=10, padx=(20, 10), sticky="nw")
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Mils (mil)", value=0)
        radio_button_1.grid(row=11, column=0, pady=10, padx=(20, 10), sticky="nw")
        ...
        radio_button_1 = customtkinter.CTkRadioButton(self, text="Mils (mil)", value=0)
        radio_button_1.grid(row=11, column=1, pady=10, padx=(20, 10), sticky="nw")
